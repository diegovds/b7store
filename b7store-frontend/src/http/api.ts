...
export type GetCategorySlugMetadata200Category = GetCategorySlugMetadata200CategoryAnyOf |  | null;
...
export const getBanners = async ( options?: RequestInit): Promise<GetBanners200> => {
...
export const getGetProductsUrl = (params?: GetProductsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `http://localhost:4444/products?${stringifiedParams}` : `http://localhost:4444/products`
}
...
export const getProductId = async (id: string, options?: RequestInit): Promise<GetProductId200> => {
 ...
 */
export const getGetProductIdRelatedUrl = (id: string,
  ...
  return stringifiedParams.length > 0 ? `http://localhost:4444/product/${id}/related?${stringifiedParams}` : `http://localhost:4444/product/${id}/related`
}

export const getProductIdRelated = async (id: string,
    params?: GetProductIdRelatedParams, options?: RequestInit): Promise<GetProductIdRelated200> => {
...
export const getCategorySlugMetadata = async (slug: string, options?: RequestInit): Promise<GetCategorySlugMetadata200> => {
...
export const postCartMount = async (postCartMountBody: PostCartMountBody, options?: RequestInit): Promise<PostCartMount200> => {
...
export const getGetCartShippingUrl = (params: GetCartShippingParams,) => {
  ...
  return stringifiedParams.length > 0 ? `http://localhost:4444/cart/shipping?${stringifiedParams}` : `http://localhost:4444/cart/shipping`
}

export const getCartShipping = async (params: GetCartShippingParams, options?: RequestInit): Promise<GetCartShipping200> => {
...
export const postUserRegister = async (postUserRegisterBody: PostUserRegisterBody, options?: RequestInit): Promise<PostUserRegister201> => {
...
export const postUserLogin = async (postUserLoginBody: PostUserLoginBody, options?: RequestInit): Promise<PostUserLogin200> => {
...
export const postUserAddresses = async (postUserAddressesBody: PostUserAddressesBody, options?: RequestInit): Promise<PostUserAddresses200> => {
...
export const getUserAddresses = async ( options?: RequestInit): Promise<GetUserAddresses200> => {
...
export const postCartFinish = async (postCartFinishBody: PostCartFinishBody, options?: RequestInit): Promise<PostCartFinish200> => {
...
export const postWebhookStripe = async (postWebhookStripeBody: string, options?: RequestInit): Promise<PostWebhookStripe200> => {
...
export const getGetOrdersSessionUrl = (params: GetOrdersSessionParams,) => {
  ...
  return stringifiedParams.length > 0 ? `http://localhost:4444/orders/session?${stringifiedParams}` : `http://localhost:4444/orders/session`
}

export const getOrdersSession = async (params: GetOrdersSessionParams, options?: RequestInit): Promise<GetOrdersSession200> => {
...
export const getOrders = async ( options?: RequestInit): Promise<GetOrders200> => {
